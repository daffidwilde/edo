...
latex_documents = [
    (master_doc, 'GeneticData.tex', 'GeneticData Documentation',
     'Henry Wilde', 'manual'),
]
...
man_pages = [
    (master_doc, 'geneticdata', 'GeneticData Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'GeneticData', 'GeneticData Documentation',
     author, 'GeneticData', 'One line description of project.',
     'Miscellaneous'),
]
